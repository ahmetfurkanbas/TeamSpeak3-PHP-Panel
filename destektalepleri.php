                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="main-card mb-3 card">
									<div class="card-header"><a href="tumtalepler.php" class="btn btn-danger">
                                    ...
                                    <div class="table-responsive">
                                        <table class="align-middle mb-0 table table-borderless table-striped table-hover">
											...
											<?php
												$taleplerim = $sql->prepare("SELECT * FROM ticket Where durum=?");
												$taleplerim->execute(array('<input type="button" class="btn btn-success" value="Açık">'));
